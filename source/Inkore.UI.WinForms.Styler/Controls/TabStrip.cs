...
namespace Inkore.UI.WinForms.Styler.Controls
{
    ...
    public class TabStrip : ToolStrip
    {
        ...
        {
            get => myRenderer.Theme;
            set { myRenderer.Theme = value; this.Invalidate(); }
        }
    ...
    internal class TabStripRenderer : ToolStripRenderer
    {
        ...
        [DefaultValue(ToolbarTheme.None)]
        public ToolbarTheme Theme { get; set; } = ToolbarTheme.None;

        public string RebarClass
        {
            get
            {
                ...
                switch (Theme)
                {
                    ...
                    case ToolbarTheme.CommunicationsToolbar:
                        Subclass = "Communications::";
                        break;
                    case ToolbarTheme.BrowserTabBar:
                        Subclass = "BrowserTabBar::";
                        break;
        ...
        {
            if (Theme != ToolbarTheme.None)
            {
                if (VisualStyleRenderer.IsElementDefined(VisualStyleElement.CreateElement(RebarClass, 6, 0)))
                    renderer.SetParameters(RebarClass, 6, 0);
                else
                ...
                renderer.DrawBackground(e.Graphics, e.ToolStrip.ClientRectangle);
