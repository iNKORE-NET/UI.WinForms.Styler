...
using Inkore.UI.WinForms.Styler.ThemeText.Options;
...
namespace Inkore.UI.WinForms.Styler.ThemeText {
	...
	/// </summary>
	//[Designer("Inkore.UI.WinForms.Styler.Design.ThemedLabelDesigner")]
	...
	public class ThemedLabel : Control {
		...
		protected override void WndProc(ref Message m) {
			if (m.Msg == Inkore.UI.WinForms.Styler.NativeMethods.WM_NCHITTEST && !DesignMode) {
				base.WndProc(ref m);

                m.Result = new IntPtr(Inkore.UI.WinForms.Styler.NativeMethods.HTTRANSPARENT);
