...
namespace Inkore.UI.WinForms.Styler.Dialogs
{
    ...
    public sealed class VistaFolderBrowserDialog : CommonDialog
    {
        ...
        protected override bool RunDialog(IntPtr hwndOwner)
        {
            ...
            try
            {
                dialog = new Inkore.UI.WinForms.Styler.Dialogs.Interop.NativeFileOpenDialog();
        ...
        private void SetDialogProperties(Inkore.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
            // Description
            ...
            dialog.SetOptions(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_PICKFOLDERS | NativeMethods.FILEOPENDIALOGOPTIONS.FOS_FORCEFILESYSTEM | NativeMethods.FILEOPENDIALOGOPTIONS.FOS_FILEMUSTEXIST);
        ...
        private void GetResult(Inkore.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
