...
namespace Inkore.UI.WinForms.Styler.Dialogs
{
    static class NativeMethods
    {
        ...
        public static extern Inkore.UI.WinForms.Styler.Dialogs.SafeModuleHandle LoadLibraryEx(
            string lpFileName,
            IntPtr hFile,
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1712:No utilizar como prefijo el nombre del tipo en valores de la enumeración", Justification = "<pendiente>")]
        internal enum FDAP
        {
