...
namespace Inkore.UI.WinForms.Styler.Dialogs
{
    ...
    public class TaskDialogButton : TaskDialogItem
    {
        ...
        /// </summary>
        /// <value>
        /// One of the <see cref="Inkore.UI.WinForms.Styler.Dialogs.ButtonType"/> values that indicates the type of the button. The default value
        /// is <see cref="Inkore.UI.WinForms.Styler.Dialogs.ButtonType.Custom"/>.
        /// </value>
        ...
        ///   is <see cref="Inkore.UI.WinForms.Styler.Dialogs.ButtonType.Custom"/>. For other button types, it is ignored.
        /// </para>
        /// <para>
