...
using iNKORE.UI.WinForms.Styler.Dwm;
using iNKORE.UI.WinForms.Styler.Native;
using System;
using iNKORE.UI.WinForms.Styler.Helpers;
...
namespace iNKORE.UI.WinForms.Styler
{
    ...
    public class AeroForm : Form
    {
        ...
        private void UpdateGlass()
        {
            ...
            if (_glassEnabled)
            {
                DwmManager.EnableGlassFrame(this, new Margins(_glassMargins.Left, _glassMargins.Right, _glassMargins.Top, _glassMargins.Bottom));
            }
            else
            {
