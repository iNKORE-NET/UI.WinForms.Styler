...
using iNKORE.UI.WinForms.Styler.Dialogs.Interop;
...
namespace iNKORE.UI.WinForms.Styler.Dialogs
{
    ...
    public abstract class AdvFileDialog : CommonDialog
    {
        internal const int HelpButtonId = 0x4001;

        private FileDialog _downlevelDialog;
        private NativeMethods.FILEOPENDIALOGOPTIONS _options;
        ...
        /// <summary>
        /// Creates a new insatnce of <see cref="AdvFileDialog" /> class.
        /// </summary>
        protected AdvFileDialog()
        {
            Reset();
        }
        ...
        /// </value>
        [Browsable(false)]
        public static bool IsAdvFileDialogSupported
        {
            get
            {
        ...
        public virtual bool CheckFileExists
        {
            get
            {
                ...
                return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_FILEMUSTEXIST);
            }
            set
            {
                if (DownlevelDialog != null)
                    ...
                    SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_FILEMUSTEXIST, value);
            }
        }
        ...
        public bool CheckPathExists
        {
            get
            {
                ...
                return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_PATHMUSTEXIST);
            }
            set
            {
                if (DownlevelDialog != null)
                    ...
                    SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_PATHMUSTEXIST, value);
            }
        }
        ...
        public bool DereferenceLinks
        {
            get
            {
                ...
                return !GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NODEREFERENCELINKS);
            }
            set
            {
                if (DownlevelDialog != null)
                    ...
                    SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NODEREFERENCELINKS, !value);
            }
        }
        ...
        public bool RestoreDirectory
        {
            get
            {
                ...
                return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NOCHANGEDIR);
            }
            set
            {
                if (DownlevelDialog != null)
                    ...
                    SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NOCHANGEDIR, value);
            }
        }
        ...
        public bool ValidateNames
        {
            get
            {
                ...
                return !GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NOVALIDATE);
            }
            set
            {
                if (DownlevelDialog != null)
                    ...
                    SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_NOVALIDATE, !value);
            }
        }
        ...
        internal void SetOption(NativeMethods.FILEOPENDIALOGOPTIONS option, bool value)
        {
            if (value)
                _options |= option;
            else
        ...
        internal bool GetOption(NativeMethods.FILEOPENDIALOGOPTIONS option)
        {
            return (_options & option) != 0;
        }

        internal virtual void GetResult(iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
            if (!GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_ALLOWMULTISELECT))
            {
                _fileNames = new string[1];
                iNKORE.UI.WinForms.Styler.Dialogs.Interop.IShellItem result;
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="AdvFileDialog" /> and optionally releases the managed resources.
        /// </summary>
        ...
        internal bool PromptUser(string text, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            string caption = string.IsNullOrEmpty(_title) ?
                (this is AdvOpenFileDialog ? ComDlgResources.LoadString(ComDlgResources.ComDlgResourceId.Open) : ComDlgResources.LoadString(ComDlgResources.ComDlgResourceId.ConfirmSaveAs)) :
                _title;
        ...
        internal virtual void SetDialogProperties(iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
            uint cookie;
            dialog.Advise(new AdvFileDialogEvents(this), out cookie);
            ...
            if (_showHelp)
            {
                iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialogCustomize customize = (iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialogCustomize)dialog;
            ...
            dialog.SetOptions((_options | NativeMethods.FILEOPENDIALOGOPTIONS.FOS_FORCEFILESYSTEM));
        }

        internal abstract iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog CreateFileDialog();
        ...
        internal bool DoFileOk(iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
            GetResult(dialog);
        ...
        private bool RunFileDialog(IntPtr hwndOwner)
        {
            ...
            iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog = null;
            try
            {
