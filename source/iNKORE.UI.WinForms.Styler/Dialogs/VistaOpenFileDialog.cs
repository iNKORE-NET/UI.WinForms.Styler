...
namespace iNKORE.UI.WinForms.Styler.Dialogs
{
    ...
    public class AdvOpenFileDialog : AdvFileDialog
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="AdvOpenFileDialog" /> class.
        /// </summary>
        public AdvOpenFileDialog()
            : this(false)
        {
        }
        ...
        public AdvOpenFileDialog(bool forceDownlevel)
        {
            if (forceDownlevel || !IsAdvFileDialogSupported)
        ...
        public bool Multiselect
        {
            get
            {
                ...
                return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_ALLOWMULTISELECT);
            }
            set
            {
                if (DownlevelDialog != null)
                ...
                SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_ALLOWMULTISELECT, value);
            }
        }
        ...
        internal override iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog CreateFileDialog()
        {
            return new Interop.NativeFileOpenDialog();
        }

        internal override void SetDialogProperties(iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
        ...
        internal override void GetResult(iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileDialog dialog)
        {
            if (Multiselect)
            {
                iNKORE.UI.WinForms.Styler.Dialogs.Interop.IShellItemArray results;
                ((iNKORE.UI.WinForms.Styler.Dialogs.Interop.IFileOpenDialog)dialog).GetResults(out results);
                uint count;
                results.GetCount(out count);
                string[] fileNames = new string[count];
                for (uint x = 0; x < count; ++x)
                {
                    iNKORE.UI.WinForms.Styler.Dialogs.Interop.IShellItem item;
