...
namespace iNKORE.UI.WinForms.Styler.Dialogs
{
    ...
    public partial class CredentialDialog : Component
    {
        ...
        {
            get { return Credentials.UserName ?? string.Empty; }
            private set
            {
                _confirmTarget = null;
        ...
        /// </summary>
        /// <value>
        /// One of the values of the <see cref="iNKORE.UI.WinForms.Styler.Dialogs.DownlevelTextMode"/> enumeration. The default value is
        /// <see cref="iNKORE.UI.WinForms.Styler.Dialogs.DownlevelTextMode.MainInstructionAndContent"/>.
        /// </value>
        /// <remarks>
        /// <para>
