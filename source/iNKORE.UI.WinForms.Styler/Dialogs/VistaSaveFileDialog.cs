...
namespace iNKORE.UI.WinForms.Styler.Dialogs
{
	...
	public class AdvSaveFileDialog : AdvFileDialog
	{
		/// <summary>
		/// Creates a new instance of <see cref="AdvSaveFileDialog" /> class.
		/// </summary>
		public AdvSaveFileDialog()
			: this(false)
		{
		}
		...
		public AdvSaveFileDialog(bool forceDownlevel)
		{
		...
		public bool CreatePrompt
		{
			get
			{
				...
				return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_CREATEPROMPT);
			}
			set
			{
				if (DownlevelDialog != null)
					...
					SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_CREATEPROMPT, value);
			}
		}
		...
		public bool OverwritePrompt
		{
			get
			{
				...
				return GetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_OVERWRITEPROMPT);
			}
			set
			{
				if (DownlevelDialog != null)
					...
					SetOption(NativeMethods.FILEOPENDIALOGOPTIONS.FOS_OVERWRITEPROMPT, value);
			}
		}
		...
		/// <exception cref="ArgumentNullException"><see cref="AdvFileDialog.FileName"/> is <see langword="null"/> or an empty string.</exception>
		...
		/// <summary>
		/// Raises the <see cref="AdvFileDialog.FileOk" /> event.
		/// </summary>
		...
		protected override void OnFileOk(CancelEventArgs e)
		{
			...
			// the prompt manually.
			if (e != null && DownlevelDialog == null)
			{
