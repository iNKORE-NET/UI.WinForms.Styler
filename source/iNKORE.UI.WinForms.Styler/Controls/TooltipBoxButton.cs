...
namespace iNKORE.UI.WinForms.Styler.Controls
{
        ...
        : Control
    {
        ...
        [Category("Appearance")]
        public TooltipButtonAction Action { get; set; } = TooltipButtonAction.Close;
        private PushButtonState state;

        /// <summary>
        /// Initializes a new instance of the <see cref="NavigationButton"/> class.
        /// </summary>
        public TooltipBoxButton()
        {
        ...
        {
            //Draw button
            new VisualStyleRenderer("Tooltip", (int)this.Action, this.Enabled ? (int)this.state : (int)PushButtonState.Disabled).DrawBackground(g, this.DisplayRectangle);
    ...
    public enum TooltipButtonAction
        {
            Close = 5,
            Wrench = 7
        }
