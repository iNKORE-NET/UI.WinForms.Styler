...
namespace iNKORE.UI.WinForms.Styler.Controls
{
        ...
        : Control
    {
        ...
        private WindowControlButtonStyle style = WindowControlButtonStyle.Close;
        ...
        [Category("Appearance")]
        public WindowControlButtonStyle Style
        {
            get { return style; }
        ...
        {
            //Draw button
            new VisualStyleRenderer("Window", (int)this.style, this.Enabled ? (int)this.state : (int)PushButtonState.Disabled).DrawBackground(g, this.DisplayRectangle);
        ...
        */
        ...
        public enum WindowControlButtonStyle
        {
            Minimize = 15,
            Maximize = 17,
            Restore = 21,
